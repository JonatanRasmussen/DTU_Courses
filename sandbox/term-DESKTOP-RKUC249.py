...
class Term:
    ...
    @classmethod
    def from_string(cls: 'Term', semester_string: str) -> 'Term':
        """ Parse a string and create a term based on its content """
        calender_year: str = ''
        dtu_semester: int = 0
        if len(semester_string) >= 3:
            dtu_semester = semester_string[0]
            if semester_string[1:3].isdigit():
                calender_year = int('20'+ semester_string[1:3])
